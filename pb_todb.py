...
def make_update_position_db_from_day(generic_path):
    '''
    INPUT
    -------
    ...
    for folder in folder_list:
        ...
        print("completed {} hour update and vehicle extraction \
                {} bad vehicle headers \
    ...
    return day_update_db, day_position_db
